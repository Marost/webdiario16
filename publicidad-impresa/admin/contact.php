      ...
      <div class="header-wgt group">
        ...
        <aside class="widget widget_search group">
          <form action="/" id="searchform1" class="searchform" method="get" role="search">
            <input size="27" type="text" title="Search" id="s1" class="s" name="s">
            <a id="searchsubmit1" class="searchsubmit"><img src="images/search.png" alt="GO"></a>
          </form>
        </aside>
      </div> <!-- .header-wgt -->
    </div> <!-- .wrap < #header -->
    ...
    <div class="inner-container half group">
      ...
      <div class="box-hold group">
        <article class="post-6 page type-page status-publish hentry entry box" id="post-6">
          ...
          <p>Hello, don't hesitate to contact me via this marvelous contact form!</p>
          ...
          <form id="contactform" action="/">
            ...
            <fieldset>
              <p>
                <input type="text" title="Reason for contact">
              </p>
            </fieldset>

            <fieldset>
              <p>
                <textarea cols="30" rows="4" title="Your Comment"></textarea>
              </p>
            </fieldset>
