...
//EDITAR
$rst_nota=mysql_query("SELECT * FROM ".$tabla_suf."_blog_noticias WHERE id=$id_url;", $conexion);
...
<div id="content">
    <div class="contentTop">
        <span class="pageTitle"><span class="icon-screen"></span>Blog - Noticias</span>
    </div>
            ...
            <fieldset>
                <div class="widget fluid">
                    ...
                    <div class="formRow">
                        ...
                        <div class="grid9"><input type="text" name="enlace" value="<?php echo $nota_enlace; ?>" /></div>
                    </div>
