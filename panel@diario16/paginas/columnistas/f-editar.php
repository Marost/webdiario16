...
//CATEGORIA
$rst_cat=mysql_query("SELECT * FROM ".$tabla_suf."_columnista_categoria ORDER BY categoria ASC;", $conexion);

//TAGS
$tags=explode(",", $fila_nota["tags"]);    //SEPARACION DE ARRAY CON COMAS
$rst_tags=mysql_query("SELECT * FROM ".$tabla_suf."_columnista_tags ORDER BY nombre ASC;", $conexion);
                    ...
                    <div class="formRow">
                        ...
                        <div class="grid9 yes_no">
                            ...
                            <div class="floatL mr10">Superior
                                ...
                                <input type="radio" name="tipo_noticia" value="not_superior" checked /></div>
                                <?php }else{ ?>
